...
public class TextScript : MonoBehaviour
{
    ...
    void Update()
    {
        if (valoranterior!= EnterTextHere) // Ejemplo de evento que cambia la variable EnterTextHere
        {
            
            // Eliminar las letras 3D existentes
            DestroyText3D();
            // Generar las nuevas letras 3D
            GenerateText3D();
        }
        valoranterior = EnterTextHere;
    }
    void GenerateText3D()
    {
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    void DestroyText3D()
    {
        // Destruye los objetos de letras 3D existentes
        if (gameobjectInstantiated != null)
        {
            foreach (GameObject obj in gameobjectInstantiated)
            {
                Destroy(obj);
            }
        }
