...
#if UNITY_EDITOR && USE_CUSTOM_EDITOR && UNITY_ANDROID
using UnityEditor;
#endif
...
public class LaserPointerController : MonoBehaviour
{
    ...
    [SerializeField] private bool GSNisPressed;
    ...
    private class LaserPointerControllerEditor : Editor
    {
        ...
        private SerializedProperty _GSNisPressed;
        ...
        private void OnEnable()
        {
            ...
            _GSNisPressed =  serializedObject.FindProperty("GSNisPressed");
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (EditorApplication.isPlayingOrWillChangePlaymode)
            {
                ...
                //EditorGUILayout.PropertyField(_GSNisPressed);
    ...
    public bool GsnIsGaze
    {
        get { return GSNisPressed; }
    ...
    private void Update()
    {
        ...
        if (hit.transform)
        {
            ...
            //echo por tadeo para el gaze
            if (GSNisPressed == true)
            {
